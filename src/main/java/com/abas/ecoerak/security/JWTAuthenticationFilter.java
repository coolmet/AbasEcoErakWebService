package com.abas.ecoerak.security;
...
import com.abas.ecoerak.service.TokenService;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter
{
	                                            ...
	                                            HttpServletResponse res) throws AuthenticationException
	{
		try
		{
			AbasUserDetailsModel creds=new ObjectMapper().readValue(req.getInputStream(),AbasUserDetailsModel.class);
	                                        ...
	                                        Authentication auth) throws IOException,ServletException
	{
		...
		//
		com.abas.ecoerak.model.User u2=new com.abas.ecoerak.model.User();
